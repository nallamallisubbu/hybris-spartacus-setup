...
describe('add-spartacus', () => {
    ...
    describe('Setup configuration', () => {
        ...
        it('should set occPrefix', () => __awaiter(void 0, void 0, void 0, function* () {
            const tree = yield schematicRunner
                .runSchematicAsync('add-spartacus', Object.assign(Object.assign({}, defaultOptions), { occPrefix: '/occ/v2/' }), appTree)
                .toPromise();
            const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
        ...
        describe('context config', () => {
            describe('baseSite', () => {
                it('should set a single baseSite', () => __awaiter(void 0, void 0, void 0, function* () {
                    const tree = yield schematicRunner
                ...
                it('should set multiple baseSites', () => __awaiter(void 0, void 0, void 0, function* () {
                    const tree = yield schematicRunner
                        .runSchematicAsync('add-spartacus', Object.assign(Object.assign({}, defaultOptions), { baseSite: 'electronics-spa,apparel-uk-spa,apparel-uk,electronics,apparel-de' }), appTree)
                        .toPromise();
                    const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
                    expect(appModule.includes(`baseSite: ['electronics-spa', 'apparel-uk-spa', 'apparel-uk', 'electronics', 'apparel-de']`)).toBe(true);
                }));
            });
        ...
        describe('currency', () => {
            it('should set the default currency when not provided', () => __awaiter(void 0, void 0, void 0, function* () {
                const tree = yield schematicRunner
                    .runSchematicAsync('add-spartacus', Object.assign({}, defaultOptions), appTree)
                    .toPromise();
                const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
                expect(appModule.includes(`currency: ['USD']`)).toBe(true);
            }));
            it('should set the single currency', () => __awaiter(void 0, void 0, void 0, function* () {
                const tree = yield schematicRunner
                    .runSchematicAsync('add-spartacus', Object.assign(Object.assign({}, defaultOptions), { currency: 'rsd' }), appTree)
                    .toPromise();
                const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
                expect(appModule.includes(`currency: ['RSD']`)).toBe(true);
            }));
            it('should set multiple currencies', () => __awaiter(void 0, void 0, void 0, function* () {
                const tree = yield schematicRunner
                    .runSchematicAsync('add-spartacus', Object.assign(Object.assign({}, defaultOptions), { currency: 'CAD,rsd' }), appTree)
                    .toPromise();
                const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
        ...
        describe('language', () => {
            it('should set the default language when not provided', () => __awaiter(void 0, void 0, void 0, function* () {
                const tree = yield schematicRunner
                    .runSchematicAsync('add-spartacus', Object.assign({}, defaultOptions), appTree)
                    .toPromise();
                const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
            ...
            it('should set the single language', () => __awaiter(void 0, void 0, void 0, function* () {
                const tree = yield schematicRunner
                    .runSchematicAsync('add-spartacus', Object.assign(Object.assign({}, defaultOptions), { language: 'SR' }), appTree)
                    .toPromise();
                const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
                expect(appModule.includes(`language: ['sr']`)).toBe(true);
            }));
            it('should set multiple languages', () => __awaiter(void 0, void 0, void 0, function* () {
                const tree = yield schematicRunner
                    .runSchematicAsync('add-spartacus', Object.assign(Object.assign({}, defaultOptions), { language: 'EN,SR' }), appTree)
                    .toPromise();
                const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
        ...
        describe('baseSite, language and currency', () => {
            it('should combine all context params properly', () => __awaiter(void 0, void 0, void 0, function* () {
                const tree = yield schematicRunner
                    .runSchematicAsync('add-spartacus', Object.assign(Object.assign({}, defaultOptions), { baseSite: 'electronics-spa,apparel-uk-spa,apparel-uk,electronics,apparel-de', currency: 'CAD,rsd', language: 'EN,SR' }), appTree)
                    .toPromise();
                const appModule = tree.readContent('/projects/schematics-test/src/app/app.module.ts');
                expect(appModule.includes(`
      context: {
        currency: ['CAD', 'RSD'],
        language: ['en', 'sr'],
