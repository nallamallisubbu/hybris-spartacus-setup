...
describe('Workspace utils', () => {
    ...
    describe('getSourceRoot', () => {
        it('should return the source root of the default project', () => __awaiter(void 0, void 0, void 0, function* () {
            const sourceRoot = workspace_utils_1.getSourceRoot(appTree, {});
    ...
    describe('getProjectFromWorkspace', () => {
        it('should return workspace project object', () => __awaiter(void 0, void 0, void 0, function* () {
            const workspaceProjectObject = workspace_utils_1.getProjectFromWorkspace(appTree, defaultOptions);
