...
describe('constructor migrations', () => {
    ...
    describe('when the class does NOT extend a Spartacus class', () => {
        it('should skip it', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', NOT_INHERITING_SPARTACUS_CLASS);
    ...
    describe('when the class has the wrong param order', () => {
        it('should NOT skip it', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', WRONG_PARAM_ORDER_BUT_VALID);
            yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
            const content = appTree.readContent('/src/index.ts');
    ...
    describe('when all the pre-conditions are valid for adding a parameter', () => {
        it('should just append the missing parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            const filePath = '/src/index.ts';
            ...
            expect(ast_utils_1.isImported(source, constants_1.AUTH_SERVICE, constants_1.SPARTACUS_CORE)).toEqual(true);
        }));
        describe('when the class has additional services injected', () => {
            it('should just append the missing parameters', () => __awaiter(void 0, void 0, void 0, function* () {
                const filePath = '/src/index.ts';
                test_utils_1.writeFile(host, filePath, ADD_PARAMETER_WITH_ADDITIONAL_INJECTED_SERVICE_VALID_TEST_CLASS);
                yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
                const content = appTree.readContent(filePath);
                const source = ts.createSourceFile(filePath, content, ts.ScriptTarget.Latest, true);
                const nodes = ast_utils_1.getSourceNodes(source);
        ...
        describe('when the service to be added is already injected', () => {
            it('should just not add the parameter', () => __awaiter(void 0, void 0, void 0, function* () {
                const filePath = '/src/index.ts';
                test_utils_1.writeFile(host, filePath, ADD_PARAMETER_WITH_ALREADY_ADDED_SERVICE_VALID_TEST_CLASS);
                yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
                const content = appTree.readContent(filePath);
                expect(content).toEqual(ADD_PARAMETER_WITH_ALREADY_ADDED_SERVICE_EXPECTED_CLASS);
            }));
        });
    });
    describe('when all the pre-conditions are valid for removing a parameter', () => {
        it('should make the required changes', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', REMOVE_PARAMETER_VALID_TEST_CLASS);
            yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
            const content = appTree.readContent('/src/index.ts');
        ...
        describe('when an additional parameter is injected', () => {
            it('should make the required changes', () => __awaiter(void 0, void 0, void 0, function* () {
                test_utils_1.writeFile(host, '/src/index.ts', REMOVE_PARAMETER_WITH_ADDITIONAL_INJECTED_SERVICE_VALID_TEST_CLASS);
                yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
                const content = appTree.readContent('/src/index.ts');
                expect(content).toEqual(REMOVE_PARAMETER_WITH_ADDITIONAL_INJECTED_SERVICE_EXPECTED_CLASS);
            }));
        });
        describe('when the param to be removed is being used elsewhere', () => {
            it('should make the required changes, but not remove the import and param from the ctor', () => __awaiter(void 0, void 0, void 0, function* () {
                test_utils_1.writeFile(host, '/src/index.ts', REMOVE_PARAMETER_BUT_NOT_IMPORT_VALID_TEST_CLASS);
                yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
                const content = appTree.readContent('/src/index.ts');
        ...
        describe('when the first constructor parameter should be removed', () => {
            it('should remove the trailing comma as well', () => __awaiter(void 0, void 0, void 0, function* () {
                test_utils_1.writeFile(host, '/src/index.ts', CART_PAGE_LAYOUT_HANDLER);
                yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
                const content = appTree.readContent('/src/index.ts');
    ...
    describe('when all the pre-conditions are valid for adding and removing parameters', () => {
        it('should make the required changes', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', ADD_AND_REMOVE_PARAMETER_VALID_TEST_CLASS);
            yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
            const content = appTree.readContent('/src/index.ts');
    ...
    describe('when the constructor has some complex logic in it', () => {
        it('should add parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', ADD_PARAM_COMPLEX_CTOR);
            yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
            const content = appTree.readContent('/src/index.ts');
    ...
    describe('when the constructor contains @Inject()', () => {
        it('should remove a parameter', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', AT_INJECT_TEST);
            yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
            const content = appTree.readContent('/src/index.ts');
