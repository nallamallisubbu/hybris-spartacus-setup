...
describe('removed public api migrations', () => {
    ...
    describe('when the import is present in the file', () => {
        it('should leave comment above it', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', REMOVED_NODE_USED_VALID_TEST);
    ...
    describe('when the imports are present in the file', () => {
        it('should leave comment above each one', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', MULTI_LINE_IMPORT_VALID_TEST);
            yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
            const content = appTree.readContent('/src/index.ts');
    ...
    describe('when namespaced import is present in the file', () => {
        it('should add comment above access to this property', () => __awaiter(void 0, void 0, void 0, function* () {
            test_utils_1.writeFile(host, '/src/index.ts', NAMESPACED_IMPORT_VALID_TEST);
            yield test_utils_1.runMigration(appTree, schematicRunner, MIGRATION_SCRIPT_NAME);
            const content = appTree.readContent('/src/index.ts');
    ...
    describe('when the import is not present in the file', () => {
        it('should not change anything', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('when the namespaced import is present in the file', () => {
        it('should not change anything when property is not access', () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=removed-public-api-deprecation_spec.js.map